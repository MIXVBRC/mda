...
$about = \Bitrix\Iblock\ElementTable::getList([
    'filter' => ['CODE' => 'nasha-komanda'],
    'select' => ['*']
])->fetch();

?><div class="about">
	<div class="about__body">
		<h2 class="about__title"><?= $about['NAME'] ?></h2>
		<div class="about__info">
			<div class="about__text">
				<?= $about['DETAIL_TEXT'] ?>
			</div>
			<div class="about__img">
                <img src="<?= \CFile::GetPath($about['DETAIL_PICTURE'])?>" alt="<?= $about['NAME'] ?>">
			</div>
		</div>
	</div>
</div>
