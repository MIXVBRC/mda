...
{
    global $arrFilter;
    $arrFilter['ITEM_ID'] = MultiShop::getFiltersByShop(MultiShop::getUserShop()['XML_ID'])['FILTER_PRODUCTS']['ID'];
	...
	else
	{
		...
		{
            $APPLICATION->SetPageProperty('SEARCH_MESSAGE', GetMessage("CT_BCSE_NOT_FOUND"));
			return;
		}
	}
}
