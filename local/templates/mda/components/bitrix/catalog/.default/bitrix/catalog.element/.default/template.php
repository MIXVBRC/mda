        ...
        <div class="container">
            <div class="element__body">
                <div class="element__img">
                    <img class="img__cover" src="img/element.jpeg" alt="">
                </div>
                <div class="element__info">
                    ...
                    <div class="element__buy-container">
                        ...
                        <a href="javascript:void(0);" class="element__buy-button" id="<?=$itemIds['ADD_BASKET_LINK']?>"><?=$arParams['MESS_BTN_ADD_TO_BASKET']?></a>
                        <div class="element__price" id="<?=$itemIds['PRICE_ID']?>"><?=$price['PRINT_RATIO_PRICE']?></div>
                    </div>
                </div>
            </div>
        </div>
