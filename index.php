...
$APPLICATION->SetPageProperty("description", "Электронные сигареты, жидкости, одноразки,  кальяны  и аксессуары в интернет-витрине MDA-medusa,  Хабаровск. Рядом с домом.  Удобная интернет-витрина электронных сигарет с широким ассортиментом и лучшими ценами.");
$APPLICATION->SetPageProperty("title", "MDA-medusa, вейп магазин электронных  сигарет и кальянов");
